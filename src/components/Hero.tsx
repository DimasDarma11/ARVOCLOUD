...
const Hero: React.FC = () => {
  ...
  return (
    <section
      id="home"
      className="relative flex items-center justify-center min-h-screen bg-gradient-to-b from-white via-blue-50/30 to-white dark:from-gray-950 dark:via-blue-950/10 dark:to-gray-950 overflow-hidden"
    >
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 py-20 md:py-32 flex flex-col items-center justify-center text-center max-w-6xl">
        <div
