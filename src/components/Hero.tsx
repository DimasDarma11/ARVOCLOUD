...
const Hero: React.FC = () => {
  ...
  return (
    <>
      ...
      <section
        id="home"
        className="relative flex items-center justify-center min-h-[95vh] bg-gradient-to-b from-white via-blue-50/30 to-white dark:from-gray-950 dark:via-blue-950/10 dark:to-gray-950 overflow-hidden"
      >
