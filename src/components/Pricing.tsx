...
const Pricing = () => {
  ...
  const plans = useMemo(() => ({
    idn: [
      { name: "1 vCPU 1GB", icon: Zap, price: { bulanan: 50000, tahunan: null }, networkType: "public" as const, specs: { cpu: "Intel Xeon E5", storage: "15 GB SSD", network: "Speed 1 Gbps", ip: "1 IPv4" } },
      { name: "1 vCPU 2GB", icon: Zap, price: { bulanan: 75000, tahunan: null }, networkType: "public" as const, specs: { cpu: "Intel Xeon E5", storage: "20 GB SSD", network: "Speed 1 Gbps", ip: "1 IPv4" } },
      { name: "2 vCPU 4GB", icon: Zap, price: { bulanan: 120000, tahunan: null }, networkType: "public" as const, specs: { cpu: "Intel Xeon E5", storage: "50 GB SSD", network: "Speed 1 Gbps", ip: "1 IPv4" } },
      { name: "4 vCPU 8GB", icon: Zap, price: { bulanan: 180000, tahunan: null }, networkType: "public" as const, specs: { cpu: "Intel Xeon E5", storage: "50 GB SSD", network: "Speed 1 Gbps", ip: "1 IPv4" } },
      { name: "8 vCPU 16GB", icon: Zap, price: { bulanan: 300000, tahunan: null }, networkType: "public" as const, specs: { cpu: "Intel Xeon E5", storage: "80 GB SSD", network: "Speed 1 Gbps", ip: "1 IPv4" } },
      { name: "8 vCPU 32GB", icon: Zap, price: { bulanan: 400000, tahunan: null }, networkType: "public" as const, specs: { cpu: "Intel Xeon E5", storage: "90 GB SSD", network: "Speed 1 Gbps", ip: "1 IPv4" } },
      { name: "2 vCPU 4GB", icon: Zap, price: { bulanan: 95000, tahunan: null }, networkType: "nat" as const, specs: { cpu: "Intel Xeon E5", storage: "20 GB SSD", network: "Speed 1 Gbps", ip: "IP NAT" } },
      { name: "4 vCPU 8GB", icon: Star, price: { bulanan: 150000, tahunan: null }, networkType: "nat" as const, specs: { cpu: "Intel Xeon E5", storage: "40 GB SSD", network: "Speed 1 Gbps", ip: "IP NAT" } },
      { name: "4 vCPU 16GB", icon: Star, price: { bulanan: 220000, tahunan: null }, networkType: "nat" as const, specs: { cpu: "Intel Xeon E5", storage: "60GB SSD", network: "Speed 1 Gbps", ip: "IP NAT" } },
      { name: "6 vCPU 16GB", icon: Star, price: { bulanan: 260000, tahunan: null }, networkType: "nat" as const, specs: { cpu: "Intel Xeon E5", storage: "60GB SSD", network: "Speed 1 Gbps", ip: "IP NAT" } },
      { name: "8 vCPU 16GB", icon: Crown, price: { bulanan: 270000, tahunan: null }, networkType: "nat" as const, specs: { cpu: "Intel Xeon E5", storage: "80 GB SSD", network: "Speed 1 Gbps", ip: "IP NAT" } },
    ],
    usa: [
      { name: "2 vCPU 1GB", icon: Zap, price: { bulanan: 50000, tahunan: null }, networkType: "nat" as const, specs: { cpu: "AMD EPYC 7551", storage: "50 GB SSD", network: "Speed 500 Mbps", ip: "1 IPv4" } },
      { name: "2 vCPU 3.5GB", icon: Zap, price: { bulanan: 100000, tahunan: null }, networkType: "nat" as const, specs: { cpu: "AMD Ryzen 7 5700G", storage: "60 GB SSD", network: "Speed 500 Mbps", ip: "IP NAT" } },
      { name: "2 vCPU 4GB", icon: Zap, price: { bulanan: 95000, tahunan: null }, networkType: "nat" as const, specs: { cpu: "Intel Xeon E5 V4", storage: "20 GB SSD", network: "Speed 1 Gbps", ip: "IP NAT" } },
      { name: "4 vCPU 6GB", icon: Zap, price: { bulanan: 135000, tahunan: null }, networkType: "nat" as const, specs: { cpu: "Intel Xeon E5 Gold 6530", storage: "75 GB SSD", network: "Speed 10 Gbps", ip: "IP NAT" } },
      { name: "4 vCPU 7GB", icon: Star, price: { bulanan: 185000, tahunan: null }, networkType: "nat" as const, specs: { cpu: "AMD Ryzen 7 5700G", storage: "120 GB SSD", network: "Speed 1 Gbps", ip: "1 IPv4" } },
      { name: "4 vCPU 8GB", icon: Crown, price: { bulanan: 150000, tahunan: null }, networkType: "nat" as const, specs: { cpu: "Intel Xeon E5 V4", storage: "40 GB SSD", network: "Speed 1 Gbps", ip: "IP NAT" } },
      { name: "6 vCPU 16GB", icon: Crown, price: { bulanan: 260000, tahunan: null }, networkType: "nat" as const, specs: { cpu: "Intel Xeon E5 V4", storage: "60 GB SSD", network: "Speed 1 Gbps", ip: "IP NAT" } },
      { name: "8 vCPU 16GB (AMD)", icon: Crown, price: { bulanan: 230000, tahunan: null }, networkType: "nat" as const, specs: { cpu: "Intel / AMD EPYC Processor", storage: "160 GB SSD", network: "Speed 1 Gbps", ip: "1 IPv4" } },
      { name: "8 vCPU 16GB (Intel)", icon: Crown, price: { bulanan: 275000, tahunan: null }, networkType: "nat" as const, specs: { cpu: "Intel Xeon E5 V4", storage: "80 GB SSD", network: "Speed 1 Gbps", ip: "IP NAT" } },
      { name: "8 vCPU 16GB DDR5", icon: Crown, price: { bulanan: 275000, tahunan: null }, networkType: "public" as const, specs: { cpu: "AMD EPYC 9645", storage: "512 GB SSD", network: "Speed 2 Gbps", ip: "1 IPv4" } },
      { name: "4 vCPU 8GB DDR5", icon: Crown, price: { bulanan: 275000, tahunan: null }, networkType: "public" as const, specs: { cpu: "AMD EPYC 9645", storage: "256 GB SSD", network: "Speed 2 Gbps", ip: "1 IPv4" } },
    ],
    sg: [
      { name: "4 vCPU 6GB", icon: Zap, price: { bulanan: 150000, tahunan: null }, networkType: "public" as const, specs: { cpu: "AMD EPYC", storage: "100 GB SSD NVMe", network: "Speed 10 Gbps", ip: "1 IPv4" } },
      { name: "6 vCPU 16GB", icon: Zap, price: { bulanan: 350000, tahunan: null }, networkType: "public" as const, specs: { cpu: "AMD EPYC", storage: "200 GB SSD NVMe", network: "Speed 10 Gbps", ip: "1 IPv4" } },
      { name: "8 vCPU 24GB", icon: Zap, price: { bulanan: 550000, tahunan: null }, networkType: "public" as const, specs: { cpu: "AMD EPYC", storage: "300 GB SSD NVMe", network: "Speed 10 Gbps", ip: "1 IPv4" } },
      { name: "12 vCPU 48GB", icon: Zap, price: { bulanan: 840000, tahunan: null }, networkType: "public" as const, specs: { cpu: "AMD EPYC", storage: "400 GB SSD NVMe", network: "Speed 10 Gbps", ip: "1 IPv4" } },
    ],
    baremetal: [
      { name: "Bare Metal ID 1", icon: Zap, price: { bulanan: 350000, tahunan: 3850000 }, networkType: "nat" as const, specs: { cpu: "Intel Core i3 Gen 6", ram: "8 GB RAM", storage: "128 GB SSD", network: "Speed 1 Gbps", emulator: "Support emulator & game" } },
      { name: "Bare Metal ID 2", icon: Star, price: { bulanan: 400000, tahunan: 4400000 }, networkType: "nat" as const, specs: { cpu: "Intel Core i3 Gen 6", ram: "16 GB RAM", storage: "128 GB SSD", network: "Speed 1 Gbps", emulator: "Support emulator & game" } },
      { name: "Bare Metal ID 3", icon: Crown, price: { bulanan: 450000, tahunan: 4950000 }, networkType: "nat" as const, specs: { cpu: "Intel Core i3 Gen 6", ram: "24 GB RAM", storage: "128 GB SSD", network: "Speed 1 Gbps", emulator: "Support emulator & game" } },
      { name: "Bare Metal ID 4", icon: Crown, price: { bulanan: 550000, tahunan: 6050000 }, networkType: "nat" as const, specs: { cpu: "Intel Core i3 Gen 6", ram: "32 GB RAM", storage: "128 GB SSD", network: "Speed 1 Gbps", emulator: "Support emulator & game" } },
      { name: "Bare Metal ID 5", icon: Star, price: { bulanan: 750000, tahunan: 8250000 }, networkType: "nat" as const, specs: { cpu: "Intel Core i7 Gen 4", ram: "32 GB RAM", storage: "256 GB SSD", network: "Speed 1 Gbps", emulator: "Support emulator & game" } },
      { name: "Bare Metal USA", icon: Star, price: { bulanan: 1500000, tahunan: 16500000 }, networkType: "public" as const, specs: { cpu: "AMD Ryzen 7 5700G", ram: "64 GB RAM", storage: "1 TB SSD", network: "Speed 1 Gbps", emulator: "Support emulator & game" } },
    ],
    proxy: [
